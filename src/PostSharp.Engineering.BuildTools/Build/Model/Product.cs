...
" );
            ...
            [NotNullWhen( true )] out DependenciesOverrideFile? dependenciesOverrideFile )
        {
            ...
            var props = this.GenerateManifestFile( version, configuration, dependenciesOverrideFile, context, settings, buildDate );
...
";
        ...
        {
            // This step is only required for pre-publishing.
            // Publishing and post-publishing get this file from artifacts.
